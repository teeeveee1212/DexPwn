...
This utility can either get into  protected files from DexProtector and copy them to a specified path, or it can be used to replace one of those files at runtime with an altered version.
